...
def bomb_lose(finall_score):
    ...
    def open_menu():
        ...
        r1 = Radiobutton(menu, text="اسان", command=first_level, font=text_font, value=1, variable=var,tristatevalue=0)
        r1.pack(side="top", pady=4, fill="x")
        r2 = Radiobutton(menu, text="متوسط", command=second_level, font=text_font, value=2, variable=var,tristatevalue=0)
        r2.pack(side="top", pady=4, fill="x")
        r3 = Radiobutton(menu, text="سخت", command=third_level, font=text_font, value=3, variable=var,tristatevalue=0)
